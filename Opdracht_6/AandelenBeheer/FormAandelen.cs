...
namespace AandelenBeheer
{
    public partial class FormAandelen : Form
    {
        ...
        private void aandelenBindingNavigatorSaveItem_Click_1(object sender, EventArgs e)
        {
            this.Validate();
            this.aandelenBindingSource.EndEdit();
            this.tableAdapterManager.UpdateAll(this.aandelenBeheerDataSet);
        ...
        private void aandelenBindingNavigatorSaveItem_Click_2(object sender, EventArgs e)
        {
            this.Validate();
            this.aandelenBindingSource.EndEdit();
            this.tableAdapterManager.UpdateAll(this.aandelenBeheerDataSet);
        ...
        private void aandelenBindingNavigatorSaveItem_Click_3(object sender, EventArgs e)
        {
            this.Validate();
            this.aandelenBindingSource.EndEdit();
            this.tableAdapterManager.UpdateAll(this.aandelenBeheerDataSet);
